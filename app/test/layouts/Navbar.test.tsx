...
describe('Navbar - Navigation Reorganization (004)', () => {
  ...
  describe('Rendering Modes', () => {
    ...
    it('mini navbar flattens Administration into separate icons', () => {
      const fullPermissions = [
        'read:plans', 'read:users', 'read:agencies', 'read:analytics'
      ]
  ...
  describe('Integration', () => {
    it('renders complete navigation structure with all sections', () => {
      const fullPermissions = [
        'read:products', 'read:categories', 'read:suppliers',
        'read:customers', 'read:salesOrders', 'read:invoices',
        'read:purchaseOrders', 'read:bills',
        'read:plans', 'read:settings', 'read:users', 'read:roles',
        'read:agencies', 'read:sites', 'read:analytics'
      ]
