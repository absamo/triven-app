...
export const categoriesArrays = {
   ...
   */
  standard: [categoryFixtures.electronics, categoryFixtures.clothing, categoryFixtures.books],
   ...
   */
  activeOnly: [categoryFixtures.electronics, categoryFixtures.clothing, categoryFixtures.minimal],

  /**
   * Only inactive categories
   */
  inactiveOnly: [categoryFixtures.books],
...
export const permissionFixtures = {
   ...
   */
  full: ['create:categories', 'read:categories', 'update:categories', 'delete:categories'],
 ...
 */
export function createCategoriesArray(
  count: number,
  baseCategory: ICategory = categoryFixtures.electronics
): ICategory[] {
