...
describe('Categories Integration Tests', () => {
            ...
            const RoutesStub = createRoutesStub([
                {
                    ...
                    Component: () => (
                        <CategoryForm
                            category={categoryFixtures.electronics}
                            errors={{}}
                        />
                    ),
                    action() {
            ...
            const RoutesStub = createRoutesStub([
                {
                    ...
                    Component: () => (
                        <CategoryForm
                            category={categoryFixtures.clothing}
                            errors={{}}
                        />
                    ),
                },
    ...
    describe('User Journey: Permission-Based Experience', () => {
        it('shows appropriate UI elements based on create permissions', () => {
            ...
            renderWithRouterContext(
                <Categories
                    categories={categories}
                    permissions={permissionFixtures.createRead}
                />
            )
    ...
    describe('User Journey: Accessibility and UX', () => {
        ...
        it('maintains proper form accessibility', () => {
            ...
            const label = screen.getByLabelText(/name/i).closest('.mantine-InputWrapper-root')?.querySelector('label')
