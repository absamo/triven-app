export default {
  ...
  inactiveUser:
    "Votre compte a été désactivé. Veuillez contacter l'administrateur de votre organisation.",
  accountDeactivated: 'Compte Désactivé',
  inactiveUserHelp:
    "Contactez l'administrateur de votre organisation pour réactiver votre compte. Il peut restaurer votre accès via le panneau de gestion d'équipe.",
  ...
  otpInvalid:
    'Le code de vérification que vous avez saisi est incorrect. Veuillez vérifier et réessayer.',
  ...
  joinTeamDescription:
    'Vous avez été invité(e) à rejoindre par {{inviterName}}. Veuillez définir votre mot de passe pour terminer la configuration de votre compte.',
  invalidInvitation: 'Invitation Invalide',
  invitationExpiredOrInvalid:
    "Ce lien d'invitation est invalide ou a expiré. Veuillez contacter votre administrateur d'équipe pour une nouvelle invitation.",
