export default {
    ...
    cancelAnytime: 'Vous pouvez annuler votre abonnement à tout moment depuis les paramètres de votre compte',
    proratedDifference: 'Vous serez facturé de la différence au prorata pour le reste de votre cycle de facturation.',
    ...
    trialEndedMessage: 'Votre essai gratuit est terminé. Mettez à niveau pour continuer à profiter de toutes les fonctionnalités puissantes de gestion d\'inventaire qui rendent votre entreprise plus efficace.',
    choosePlan: 'Choisissez un plan pour continuer à utiliser Triven',
    continueWithPlan: 'Continuer avec le plan {{planName}}',
    flexiblePricing: 'Choisissez parmi des plans tarifaires flexibles qui correspondent aux besoins de votre entreprise',
