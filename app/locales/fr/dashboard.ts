export default {
    ...
    inventoryAccuracyTooltip: 'Mesure à quel point votre stock physique correspond à vos enregistrements système. Calculé en comparant le Stock Physique en Main vs le Stock Comptable en Main pour chaque produit. Des pourcentages plus élevés indiquent un meilleur contrôle de l\'inventaire.',
    reorderPointAlerts: 'Alertes Point de Réapprovisionnement',
    reorderPointAlertsTooltip: 'Affiche le nombre de produits qui sont à ou en dessous de leur seuil de point de réapprovisionnement. Ces produits peuvent avoir besoin d\'être réapprovisionnés bientôt pour éviter les ruptures de stock.',
    deadStockValue: 'Valeur du Stock Mort',
    deadStockValueTooltip: 'Affiche la valeur totale des produits qui n\'ont eu aucune vente, achat ou ajustement au cours des 90 derniers jours. Ces articles peuvent être candidats à la liquidation ou à la tarification promotionnelle.',
    ...
    monthlySalesData: 'Données de ventes mensuelles montrant les tendances du nombre de commandes et des revenus',
