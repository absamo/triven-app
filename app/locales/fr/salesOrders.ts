export default {
    ...
    atLeastOneSalesOrderItemRequired: 'Au moins un article de commande de vente est requis pour créer une commande de vente',
    ...
    backorderRequired: 'Certains articles sont en rupture de stock et nécessitent des commandes en rupture',
}
