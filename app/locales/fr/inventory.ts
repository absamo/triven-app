export default {
    ...
    selectFileDescription: 'Sélectionnez le fichier CSV contenant les données produit à importer. Vous pouvez télécharger notre modèle pour commencer.',
    downloadTemplate: 'Télécharger le Modèle CSV',
    dragDropFiles: 'Glissez le fichier CSV ici ou cliquez pour sélectionner',
    fileRequirements: 'Joignez un fichier CSV avec les données produit. Le fichier ne doit pas dépasser 5 Mo',
    fileSelected: 'Fichier sélectionné',
    mapFields: 'Mapper les Champs',
    configureFieldMapping: 'Configurer le mappage des champs',
    mapFieldsDescription: 'Examinez le format de votre fichier CSV. Le processus d\'importation validera vos données et fournira des messages d\'erreur détaillés si des problèmes sont détectés.',
    ...
    reviewDescription: 'Examinez vos paramètres et terminez le processus d\'importation. Cela ajoutera de nouveaux produits à votre inventaire.',
    ...
    noProductsImported: 'Aucun produit n\'a été importé. Tous les produits ont échoué à la validation.',
    noCategoriesImported: 'Aucune catégorie n\'a été importée. Toutes les catégories ont échoué à la validation.',
    ...
    duplicateProductNamesRejected: 'Les noms de produits en double seront rejetés lors de l\'importation',
    duplicateCategoryNamesRejected: 'Les noms de catégories en double seront rejetés lors de l\'importation',
    invalidFieldsRejected: 'Les champs invalides ou manquants entraîneront le rejet des lignes',
    detailedValidationResults: 'Les résultats de validation détaillés seront affichés après traitement',
