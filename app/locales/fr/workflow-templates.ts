export default {
  ...
  messages: {
    ...
    noTemplatesDescription:
      "Créez votre premier modèle de workflow pour rationaliser les processus d'approbation.",
    noMatchingTemplates:
      "Aucun modèle ne correspond aux filtres actuels. Essayez d'ajuster vos critères de recherche.",
  },
