export default {
    ...
    backorderItemRequired: 'Veuillez ajouter un article de commande en attente avant de soumettre le formulaire',
    noProductSelectedError: 'Veuillez sélectionner un produit pour tous les articles de commande en attente',
    invalidQuantityError: 'Veuillez entrer une quantité valide pour tous les articles de commande en attente',
