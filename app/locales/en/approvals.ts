export default {
    ...
    modal: {
        ...
        rejectAlert: 'You are about to reject this request. Please provide a clear reason for the rejection.',
        reviewAlert: 'Add your review comments. This will mark the request as "In Review" and notify relevant parties.',
        reopenAlert: 'You are about to reopen this request for further review. Please provide a reason for reopening.',
    ...
    messages: {
        ...
        noMatchingRequests: 'No requests match the current filters. Try adjusting your search criteria.',
    ...
    demo: {
        ...
        // Sample comments
        managerReviewComment: 'I am reviewing this order. The amount is high but justified by our current equipment needs.',
        salesRecommendationComment: 'Customer recommended by a trusted partner. Excellent payment history.',
        managerApprovalComment: 'Thank you for this information. I approve the customer account creation.'
    }
