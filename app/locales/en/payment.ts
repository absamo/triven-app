export default {
    ...
    proratedDifference: 'You\'ll be charged the prorated difference for the remainder of your billing cycle.',
    ...
    trialEndedMessage: 'Your free trial has ended. Upgrade to continue enjoying all the powerful inventory management features that make your business more efficient.',
