export default {
    ...
    inactiveUser: 'Your account has been deactivated. Please contact your organization administrator.',
    accountDeactivated: 'Account Deactivated',
    inactiveUserHelp: 'Contact your organization administrator to reactivate your account. They can restore your access through the team management panel.',
    ...
    joinTeamDescription: 'You have been invited to join by {{inviterName}}. Please set your password to complete your account setup.',
    invalidInvitation: 'Invalid Invitation',
    invitationExpiredOrInvalid: 'This invitation link is invalid or has expired. Please contact your team administrator for a new invitation.',
