...
export const meta: MetaFunction = () => {
  return [
    { title: 'Triven - AI-Powered Inventory Management Platform' },
    {
      name: 'description',
      content:
        'Transform inventory chaos into intelligent business growth. AI-powered inventory management with real-time insights, predictive forecasting, and automated workflows.',
    },
    {
      name: 'keywords',
      content:
        'AI inventory management, intelligent forecasting, real-time visibility, stock control, inventory optimization, data-driven decisions, inventory platform, warehouse management',
    },
  ]
}
  ...
  const pricingPlans: PricingPlan[] = [
    {
      ...
      monthlyPrice: 29,
      yearlyPrice: 19,
      features: ['Custom categories and tags', 'Purchase order management'],
      mainFeatures: [
        'Company management',
        'User management',
        'Product management',
    ...
    },
    {
      ...
      mainFeatures: ['AI-powered insights', 'Demand forecasting', 'Automatic reordering'],
      limits: {
      ...
      <div className={classes.root}>
                  ...
                  <Stack gap="xl">
                      ...
                      <Group gap="lg" align="center">
                        ...
                        <Stack gap={4}>
                          <Text className={classes.progressLabel}>
                            {t('home:accurateInventory.autoCategory')}
                          </Text>
                          <Text className={classes.progressSubLabel}>
                            {t('home:accurateInventory.autoCategorySub')}
                          </Text>
                        </Stack>
                      </Group>
                    </Box>
                    ...
                    <Box className={classes.progressItem}>
                      <Group gap="lg" align="center">
                        ...
                        <Stack gap={4}>
                          <Text className={classes.progressLabel}>
                            {t('home:accurateInventory.stockMovements')}
                          </Text>
                          <Text className={classes.progressSubLabel}>
                            {t('home:accurateInventory.stockMovementsSub')}
                          </Text>
                        </Stack>
                      </Group>
                    </Box>
                      ...
                      <Stack gap="md">
                        <Group justify="space-between" align="center">
                          <Text className={classes.previewTitle}>
                            {t('home:accurateInventory.dashboardTitle')}
                          </Text>
                          <Badge variant="light" color="green" size="sm">
                            {t('home:accurateInventory.realTime')}
                          </Badge>
                        </Group>
                        ...
                        <Box className={classes.miniChart}>
                          ...
                          <Text className={classes.chartLabel}>
                            {t('home:accurateInventory.chartLabel')}
                          </Text>
                        </Box>
                      </Stack>
                    </Card>
        ...
        >
          ...
          <div className={classes.backgroundElements}>
            ...
            <div className={classes.neonOrb} style={{ opacity: isDark ? 1 : 0 }}></div>
            <div className={classes.neonOrb2} style={{ opacity: isDark ? 1 : 0 }}></div>

            {/* Light mode background elements */}
            <div className={classes.lightModeOrb1} style={{ opacity: isDark ? 0 : 1 }}></div>
            <div className={classes.lightModeOrb2} style={{ opacity: isDark ? 0 : 1 }}></div>
          </div>
          ...
          <Container size="xl" py={80} className={classes.container}>
            ...
            <Group
              ...
              className={
                isDark
                  ? classes.billingToggle
                  : `${classes.billingToggle} ${classes.billingToggleLight}`
              }
            >
              <Text
                size="md"
                ...
                className={
                  isDark
                    ? classes.billingLabel
                    : `${classes.billingLabel} ${classes.billingLabelDark}`
                }
              >
                {t('pricing:monthly')}
              </Text>
                            ...
                            <Group gap="xs" align="center">
                              <ThemeIcon
                                ...
                                style={{
                                  ...
                                  boxShadow: isPopular
                                    ? `0 0 20px rgba(${theme.colors.neon[6]}, 0.2)`
                                    : 'none',
                                }}
                              >
                                <Icon size={16} />
                            ...
                            <Stack gap="md">
                              <Group justify="space-between">
                                <Group gap={8}>
                                  ...
                                  <Text size="sm" c="dimmed">
                                    {t('pricing:salesOrders')}
                                  </Text>
                                </Group>
                                <Text size="sm" fw={600} c={isDark ? 'white' : 'dark'}>
                                  {plan.limits.salesOrders === 'Unlimited'
                                    ? t('pricing:unlimited')
                              ...
                              <Group justify="space-between">
                                <Group gap={8}>
                                  ...
                                  <Text size="sm" c="dimmed">
                                    {t('pricing:purchaseOrders')}
                                  </Text>
                                </Group>
                                <Text size="sm" fw={600} c={isDark ? 'white' : 'dark'}>
                                  {plan.limits.purchaseOrders === 'Unlimited'
                                    ? t('pricing:unlimited')
                              ...
                              <Group justify="space-between">
                                ...
                                <Text size="sm" fw={600} c={isDark ? 'white' : 'dark'}>
                                  {plan.limits.users}{' '}
                                  {plan.limits.users === 1 ? t('pricing:user') : t('pricing:users')}
                                </Text>
                              </Group>
                              ...
                              <Group justify="space-between">
                                ...
                                <Text size="sm" fw={600} c={isDark ? 'white' : 'dark'}>
                                  {plan.limits.reporting === 'Basic reporting'
                                    ? t('pricing:basicReporting')
                                    : plan.limits.reporting === 'Advanced reporting'
                              ...
                              <Group justify="space-between">
                                ...
                                <Text size="sm" fw={600} c={isDark ? 'white' : 'dark'}>
                                  {plan.limits.agencies}{' '}
                                  {plan.limits.agencies === 1
                                    ? t('pricing:agency')
                                    : t('pricing:agencies')}
                                </Text>
                              </Group>
                              ...
                              <Group justify="space-between">
                                ...
                                <Text size="sm" fw={600} c={isDark ? 'white' : 'dark'}>
                                  {plan.limits.sites}{' '}
                                  {plan.limits.sites === 1 ? t('pricing:site') : t('pricing:sites')}
                                </Text>
                              </Group>
                            </Stack>
                          </Paper>
                            ...
                            >
                                ...
                                const getFeatureTranslation = (feature: string) => {
                                  const featureMap: Record<string, string> = {
                                    ...
                                    'Multi-language support': t(
                                      'pricing:features.internationalization'
                                    ),
                              ...
                              {plan.features.slice(0, 6).map((feature, index) => {
                                const getAdditionalFeatureTranslation = (feature: string) => {
                                  const featureMap: Record<string, string> = {
                                    'Custom categories and tags': t(
                                      'pricing:features.customCategories'
                                    ),
                                    'Purchase order management': t(
                                      'pricing:features.purchaseOrderManagement'
                                    ),
                                    'Advanced inventory tracking': t(
                                      'pricing:features.advancedInventory'
                                    ),
                                    'Stock transfer management': t(
                                      'pricing:features.stockTransfer'
                                    ),
            ...
            >
              <Stack align="center" gap="lg">
                ...
                <Text c="dimmed" maw={500} mx="auto" style={{ lineHeight: 1.6 }}>
          ...
          <Container size="xl" py={120}>
            <Box className={classes.finalCta}>
              <Stack gap={30} align="center" ta="center">
                ...
                <Button component={Link} to="/signup" size="xl" className={classes.primaryCTA}>
