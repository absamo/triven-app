      ...
      <Stack gap="xl">
        <div>
          ...
          <Text size="lg" c="dimmed">
            Get your business up and running with our step-by-step integration guide. Complete these
            essential steps to start managing your inventory and operations.
          </Text>
        </div>
                ...
                <Group justify="space-between" mb="md">
                  <Group>
                    ...
                    <div>
                      ...
                      <Badge color={getStatusColor(step.status)} variant="light" size="sm">
                        {getStatusLabel(step.status)}
                      </Badge>
                    </div>
                  </Group>
                  {isActionable && <IconChevronRight size={20} />}
                </Group>
        ...
        <Card shadow="sm" p="lg" radius="md" withBorder>
          ...
          <Text size="sm">
            If you encounter any issues during setup, please don't hesitate to reach out. We provide
            comprehensive documentation and personalized support to ensure your success.
          </Text>
        </Card>
      </Stack>
