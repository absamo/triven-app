...
const keyFeatures = [
  {
    ...
    description:
      'Real-time stock tracking with AI-powered forecasting, automated reordering, and barcode scanning',
  },
  {
    icon: IconChartPie3,
    title: 'AI-Powered Analytics & Insights',
    description:
      'Business intelligence dashboard with predictive insights, intelligent forecasting, and advanced audit trails',
  },
  {
    icon: IconBuilding,
    title: 'Multi-Location Support',
    description:
      'Seamlessly manage inventory across warehouses, stores, and distribution centers with stock transfers',
  },
  {
    icon: IconFileInvoice,
    title: 'Complete Business Operations',
    description:
      'Sales orders, purchase orders, invoicing, bills & payments with custom workflows and approvals',
  },
  {
    icon: IconScan,
    title: 'Modern Technology',
    description:
      'Barcode scanning, mobile support, API integrations, and import/export capabilities',
  },
  {
    icon: IconCurrency,
    title: 'Global Business Ready',
    description:
      'Multi-currency support, internationalization, and enterprise-grade security features',
  },
]
              ...
              <div className={classes.contentSection}>
                <div className={classes.heroContent}>
                  <Title order={1} className={classes.mainTitle}>
                    See <span className={classes.brandHighlight}>Triven</span> in Action
                  </Title>

                  <Text className={classes.subtitle}>
                    Discover how Triven's AI-powered inventory management platform can transform
                    your business operations. Schedule a demo and see real results.
                  </Text>
                </div>
                  ...
                  <div className={classes.benefitsList}>
                    {benefits.map((benefit, index) => (
                      <div key={index} className={classes.benefit}>
                        ...
                        <Text size="sm" className={classes.benefitText}>
                          {benefit}
                        </Text>
                      </div>
                    ))}
