    ...
    const handleSubmit = async (values: { password: string; confirmPassword: string }) => {
        ...
        try {
            ...
            if (result.error) {
                ...
                if (result.error.message?.includes('token') || result.error.message?.includes('expired') || result.error.message?.includes('invalid')) {
    ...
    if (!token || tokenError) {
        return (
            <div style={{
                ...
                <Paper withBorder shadow="xl" p={40} radius="lg" style={{ background: 'white', maxWidth: 450, margin: '0 auto' }}>
                    ...
                    <Center mb={24}>
                        <Text size="sm" c="#6B7280" ta="center" lh={1.5}>
                            This reset link is no longer valid. Please request a new one to continue with your password reset.
                        </Text>
                    </Center>
                    <Center>
                        <Button
