...
export default function BusinessSetup({ user, error }: BusinessSetupProps) {
  ...
  const validateStep = (step: number) => {
    switch (step) {
      ...
      case 1:
        return form.values.agencyName && form.values.agencyCountry && form.values.agencyCity
      case 2:
        return (
          form.values.warehouseName && form.values.warehouseCountry && form.values.warehouseCity
        )
      default:
        return false
    }
        ...
        >
          ...
          <Center mb="xl">
            <Text size="sm" c="dimmed" ta="center">
              Welcome {`${user?.profile?.firstName} (${user?.email})`}! Let's set up your business
              details to get started.
            </Text>
          </Center>

          {error && (
            <Alert icon={<IconAlertCircle size={16} />} title="Setup Error" color="red" mb="md">
              {error}
            </Alert>
          )}
                    ...
                    >
                      ...
                      <div>
                        ...
                        <Text size="xs" c="dimmed">
                          This will be your main business agency. You can create additional agencies
                          later.
                        </Text>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <Text size="xs" c="dimmed">
                          Your main warehouse location for inventory management. Additional
