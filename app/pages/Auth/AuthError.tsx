...
const ERROR_MESSAGES: Record<string, { title: string; message: string; action?: string }> = {
  unable_to_create_user: {
    ...
    message:
      'We encountered an issue while creating your account. This might be because an account with this email already exists or there was a temporary server issue.',
    ...
    >
      <Container size="sm">
        <div style={{ width: '100%', maxWidth: 500, margin: '0 auto' }}>
          {/* Logo */}
          <Center mb="xl">
            <Image src="/assets/triven-logo.png" alt="TRIVEN" w={130} fit="contain" />
          </Center>
                  ...
                  <Collapse in={debugOpened}>
                    ...
                    >
                      <Text size="xs" c="dimmed">
                        <strong>Error Code:</strong> {urlError}
                        <br />
                        {urlErrorDescription && (
                          <>
                            <strong>Description:</strong> {urlErrorDescription}
                            <br />
                          </>
                        )}
