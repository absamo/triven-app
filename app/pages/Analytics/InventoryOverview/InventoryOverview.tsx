    ...
    <div className={classes.container}>
      <div className={classes.header}>
        ...
        <Text className={classes.description}>
          Comprehensive inventory analytics including stock levels, order quantities, and
          availability.
        </Text>
      </div>
      ...
      <Table striped highlightOnHover withTableBorder withColumnBorders className={classes.table}>
        <Table.Thead>
          <Table.Tr className={classes.tableHeader}>
            <Table.Th className={classes.tableHeaderCell}>Product Name</Table.Th>
            <Table.Th className={classes.tableHeaderCellRight}>Qty Ordered</Table.Th>
            <Table.Th className={classes.tableHeaderCellRight}>Qty In</Table.Th>
            <Table.Th className={classes.tableHeaderCellRight}>Qty Out</Table.Th>
            <Table.Th className={classes.tableHeaderCellRight}>Stock on Hand</Table.Th>
            <Table.Th className={classes.tableHeaderCellRight}>Committed Stock</Table.Th>
            <Table.Th className={classes.tableHeaderCellRight}>Available for Sale</Table.Th>
          </Table.Tr>
        </Table.Thead>
        <Table.Tbody>
          {analyticsData.products.map((product) => (
            <Table.Tr key={product.id}>
              ...
              <Table.Td className={classes.tableCellRight}>
                <Text
                  size="sm"
                  className={`${classes.availableStock} ${
        ...
        <div className={classes.emptyState}>
          <Text className={classes.emptyStateText}>
            {t(
              ...
              'No products found. Add some products to see inventory details.'
            )}
          </Text>
        </div>
      )}
