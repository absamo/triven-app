...
export default function PricingPage() {
  ...
  const pricingPlans: PricingPlan[] = [
    ...
    },
    {
      ...
      mainFeatures: [t('pricing:features.integrations')],
      limits: {
        salesOrders: '1,000',
      ...
      <Container size="xl" py={80} className={classes.container}>
        ...
        >
          <Text
            ...
            fw={500}
            className={
              isDark ? classes.billingLabel : `${classes.billingLabel} ${classes.billingLabelDark}`
            }
          >
            {t('pricing:monthly')}
          </Text>
              ...
              {pricingPlans.map((plan, index) => {
                ...
                return (
                  ...
                  >
                    <Group gap="sm" align="flex-start">
                      ...
                      <div style={{ flex: 1 }}>
                        <Text
                          ...
                          fw={600}
                          c={isDark ? 'white' : 'dark'}
                          className={classes.stickyPlanName}
                        >
                          {plan.name}
                        </Text>
                        <Text
                          size="xs"
                          c="dimmed"
                          className={classes.stickyPlanDescription}
                          lineClamp={2}
                        >
                          {plan.description}
                        </Text>
                        <Text
                          size="lg"
                          fw={800}
                          c={isPopular ? 'neon' : isDark ? 'white' : 'dark'}
                          className={classes.stickyPlanPrice}
                        >
                    ...
                    {isPopular && <div className={classes.stickyPopularBadge}>Popular</div>}
                  </div>
                )
              })}
            </div>
          ...
          {pricingPlans.map((plan, index) => {
            ...
            return (
              ...
              >
                ...
                <Stack gap="lg" className={classes.cardContent}>
                  {/* Plan Header */}
                  <Stack gap="sm">
                    ...
                    <Stack gap="md">
                      ...
                      <Group justify="space-between">
                        ...
                        <Text size="sm" fw={600} c={isDark ? 'white' : 'dark'}>
                          ...
                          {plan.limits.agencies === 1 ? t('pricing:agency') : t('pricing:agencies')}
                        </Text>
                      </Group>
