        ...
        >
            ...
            <div style={{ width: '100%', maxWidth: 600 }}>
                ...
                >
                    {/* Welcome Header */}
                    <Center mb={8}>
                        <Title order={2} size="h2" fw={600} c={`light-dark(${theme.colors.gray[8]}, ${theme.colors.gray[0]})`}>
                            {t('auth:welcomeBack')}
                        </Title>
                    </Center>
                    ...
                    <Stack gap="md">
                        ...
                        <form onSubmit={form.onSubmit(handleEmailSignIn)}>
                            <Stack gap="md">
                                <TextInput
                                    label={t('auth:email')}
                                    leftSection={<IconMail size={18} color={`light-dark(${theme.colors.gray[6]}, ${theme.colors.gray[4]})`} />}
                                ...
                                <PasswordInput
                                    ...
                                    leftSection={<IconLock size={18} color={`light-dark(${theme.colors.gray[6]}, ${theme.colors.gray[4]})`} />}
                        ...
                        <Center mt={10}>
                            <Text size="xs" c="dimmed">
                                <Text component="span" fw={700}>{t('auth:dontHaveAccount')}</Text>{' '}
