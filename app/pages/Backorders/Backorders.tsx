...
export default function BackordersPage({
    ...
    const rows = (data?.backorders || backorders).map(
        (backorder: IBackorder) => {
            ...
            const baseCurrency = backorder.company?.currencies?.find(
            ...
            return (
                ...
                >
                    <Table.Td>
                        <Text size="sm">
                            {dayjs(backorder.originalOrderDate).format("DD-MM-YYYY")}
                        </Text>
                    </Table.Td>
        ...
        <>
            ...
            <Text size="sm" c="dimmed" mt="md" ta="center">
                {rows.length === 1
                    ...
                    : t('showingCount', 'Showing {{count}} backorders').replace('{{count}}', rows.length.toString())
                }
            </Text>
        </>
    )
