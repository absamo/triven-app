...
export default function PaymentsMadePage({
  ...
  const rows = (data?.paymentsMade || paymentsMade).map(
    (paymentMade: IPaymentsMade) => {
      ...
      return (
        ...
        >
          <Table.Td>
            <Text size="sm">
              {dayjs(paymentMade.paymentDate).format("DD-MM-YYYY")}
            </Text>
          </Table.Td>
          ...
          <Table.Td>
            <Text size="sm">{formatCurrency(getTotalAmountDueByBill(
              paymentMade.bill as IBill
            ), currency?.symbol || '$')}</Text>
          </Table.Td>
          <Table.Td>
            <Text size="sm">{formatCurrency(paymentMade.amountReceived, currency?.symbol || '$')}</Text>
          </Table.Td>
          <Table.Td>
                  ...
                  <Menu.Item
                    ...
                    state={{
                      purchaseOrderReference:
                        paymentMade.bill?.purchaseOrder?.purchaseOrderReference,
