...
interface DashboardUpdateEvent {
    action: "product_created" | "product_updated" | "stock_adjustment_created" | "stock_adjustment_updated" | "bulk_products_imported" | "sales_order_created" | "sales_order_updated"
    product?: {
        id: string
        name: string
        openingStock?: number
