      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={section}>
            ...
            <Text style={text}>
              Congratulations! Your business setup is complete and your Triven account is now fully
              active.
            </Text>
            <Text style={text}>
              You can now access all features of our platform including inventory management, order
              tracking, and analytics for your business.
            </Text>
