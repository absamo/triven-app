...
export default function SalesOrdersCreateRoute({
  loaderData,
  actionData,
}: Route.ComponentProps) {
  const { salesOrder, agencies, customers, currency, sites, products } =
