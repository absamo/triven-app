...
function handleAuthError(error: unknown, url: URL): Response {
    ...
    if (error instanceof Error) {
        ...
        if (errorMessage.includes('session expired') || errorMessage.includes('invalid session') || errorMessage.includes('session not found')) {
        ...
        } else if (errorMessage.includes('unable to create user') || errorMessage.includes('creation failed')) {
