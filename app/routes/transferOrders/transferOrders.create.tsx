...
import {
  createTransferOrder,
  getMaxTransferOrderNumber,
} from "~/app/services/transferOrders"
...
export const action: ActionFunction = async ({
  ...
  const transferOrderReference = formData.get(
  ...
  const transferOrderDate = JSON.parse(
    formData.get("transferOrderDate") as string
  )
  const transferOrderItems = JSON.parse(
    formData.get("transferOrderItems") as string
  )
...
export default function CreateStoresRoute({
  loaderData,
  actionData,
