...
export const imagePresets = {
    ...
    gallery: { width: 800, height: 600, crop: 'at_max' as const, quality: 85, format: 'webp' as const },
    preview: { width: 300, height: 200, crop: 'force' as const, quality: 70, format: 'webp' as const },
} as const
