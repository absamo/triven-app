...
/**
 * Translation strings for tool outputs
 */
const translations = {
  en: {
    allStocked: 'All products are adequately stocked! No reorder recommendations at this time.',
    foundProducts: 'Found',
    productsNeedingReorder: 'products that need reordering',
    tip: 'Tip:',
    sortedByUrgency: 'Products are sorted by urgency (lowest days until stockout first).',
    product: 'Product',
    sku: 'SKU',
    currentStock: 'Current Stock',
    reorderPoint: 'Reorder Point',
    daysUntilStockout: 'Days Until Stockout',
    suggestedOrderQty: 'Suggested Order Qty',
    noSalesRecorded: 'No sales recorded in the last',
    days: 'days',
    topSellingProducts: 'Top',
    sellingProducts: 'selling products (last',
    ...
    velocity: 'Velocity',
    revenue: 'Revenue',
    inventoryHealthReport: 'Inventory Health Report',
    ...
    productsNeedingReorderCount: 'Products Needing Reorder',
    urgent: 'Urgent (< 7 days)',
    soon: 'Soon (7-14 days)',
    turnoverBenchmarks: 'Turnover Rate Benchmarks',
    range: 'Range',
    rating: 'Rating',
    description: 'Description',
    poor: 'Poor',
    overstocking: 'Overstocking - Inventory moving too slowly',
    fair: 'Fair',
    roomForImprovement: 'Room for improvement',
    good: 'Good',
    healthyInventory: 'Healthy inventory movement',
    excellent: 'Excellent',
    fastMoving: 'Fast-moving inventory',
    recommendation: 'Recommendation',
    takeImmediateAction: 'Take immediate action',
    productWithUrgent: 'product(s) with urgent reorder needs (< 7 days until stockout).',
    monitorClosely: 'Monitor closely:',
    productApproaching: 'product(s) approaching reorder points.',
    allGood: 'All good!',
    inventoryHealthy: 'Inventory levels are healthy across the board.',
    poorMoving: 'Poor - Inventory is moving slowly',
    excellentMoving: 'Excellent - Inventory is moving very fast',
    goodMoving: 'Good - Healthy inventory movement',
    fairMoving: 'Fair - Room for improvement',
  },
  fr: {
    allStocked:
      'Tous les produits sont bien approvisionnés ! Aucune recommandation de réapprovisionnement pour le moment.',
    foundProducts: 'Trouvé',
    productsNeedingReorder: 'produits nécessitant un réapprovisionnement',
    tip: 'Conseil :',
    sortedByUrgency: 'Les produits sont triés par urgence (jours restants avant rupture de stock).',
    product: 'Produit',
    sku: 'SKU',
    currentStock: 'Stock Actuel',
    reorderPoint: 'Seuil de Réapprovisionnement',
    daysUntilStockout: 'Jours Avant Rupture',
    suggestedOrderQty: 'Quantité Suggérée',
    noSalesRecorded: 'Aucune vente enregistrée au cours des derniers',
    days: 'jours',
    topSellingProducts: 'Top',
    sellingProducts: 'produits les plus vendus (derniers',
    ...
    velocity: 'Vélocité',
    revenue: 'Revenu',
    inventoryHealthReport: 'Rapport de Santé des Stocks',
    dayPeriod: 'jours',
    ...
    productsNeedingReorderCount: 'Produits à Réapprovisionner',
    urgent: 'Urgent (< 7 jours)',
    soon: 'Bientôt (7-14 jours)',
    turnoverBenchmarks: 'Références de Taux de Rotation',
    range: 'Plage',
    rating: 'Note',
    description: 'Description',
    poor: 'Faible',
    overstocking: 'Surstockage - Stock se déplaçant trop lentement',
    fair: 'Correct',
    roomForImprovement: "Place à l'amélioration",
    good: 'Bon',
    healthyInventory: 'Mouvement sain des stocks',
    excellent: 'Excellent',
    fastMoving: 'Stock se déplaçant rapidement',
    recommendation: 'Recommandation',
    takeImmediateAction: 'Agir immédiatement',
    productWithUrgent:
      'produit(s) nécessitant un réapprovisionnement urgent (< 7 jours avant rupture).',
    monitorClosely: 'Surveiller de près :',
    productApproaching: 'produit(s) approchant des seuils de réapprovisionnement.',
    allGood: 'Tout va bien !',
    inventoryHealthy: 'Les niveaux de stock sont sains dans tous les secteurs.',
    poorMoving: 'Faible - Le stock se déplace lentement',
    excellentMoving: 'Excellent - Le stock se déplace très rapidement',
    goodMoving: 'Bon - Mouvement sain du stock',
    fairMoving: "Correct - Place à l'amélioration",
  },
}
 ...
 */
function t(key: keyof typeof translations.en, lang: 'en' | 'fr' = 'en'): string {
