...
export default function ApprovalActionModal({
    ...
    const getActionTitle = () => {
        switch (actionType) {
            case 'reject': return t('approvals:modal.rejectRequest')
            case 'review': return t('approvals:modal.comments', 'Comments')
            case 'add_review': return t('approvals:modal.reviewRequest', 'Review Request')
            case 'reopen': return t('approvals:modal.reopenRequest')
            default: return t('approvals:modal.requestAction', 'Request Action')
        }
    }
    ...
    const getActionIcon = () => {
        switch (actionType) {
            case 'reject': return <IconCircleX size={20} />
            case 'review': return <IconMessageCircle size={20} />
            case 'add_review': return <IconEye size={20} />
            case 'reopen': return <IconRefresh size={20} />
        ...
        <Modal
            ...
            title={
                <Group>
                    ...
                    <div>
                        <Text size="lg" fw={600}>{getActionTitle()}</Text>
                        <Text size="sm" c="dimmed">{request.title}</Text>
                    </div>
                </Group>
            }
            size="xl"
                    ...
                    <ScrollArea style={{ height: '400px' }}>
                        {request.comments && request.comments.length > 0 ? (
                                    ...
                                    <Timeline.Item
                                        ...
                                        title={
                                            <Group gap="xs">
                                                ...
                                                {comment.isInternal && (
                                                    <Badge size="xs" color="orange">{t('approvals:modal.internal')}</Badge>
                                                )}
                                            </Group>
                                        }
                                    >
                            ...
                            <Paper p="xl" withBorder radius="md" style={{ textAlign: 'center' }}>
                                ...
                                <Text c="dimmed" size="sm">{t('approvals:modal.noComments')}</Text>
                            </Paper>
                        )}
                    </ScrollArea>
                ) : (
                            ...
                            <Stack gap="md">
                                ...
                                <Group justify="flex-end" gap="sm" >
                                    ...
                                    >
                                        ...
                                        {actionType === 'add_review' && t('approvals:modal.addReviewComment', 'Add Review Comment')}
