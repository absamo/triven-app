...
import {
  ...
  formatPrice,
  useSubscription,
} from '~/app/lib/hooks/useSubscription'
import {
  CURRENCIES,
  INTERVALS,
  type Interval,
...
export function PricingExample() {
  ...
  return (
    ...
    >
      <PricingCard planId={PLANS.STANDARD} interval={interval} currency={currency} />
      <PricingCard
        ...
        isPopular={true}
      />
      <PricingCard planId={PLANS.PREMIUM} interval={interval} currency={currency} />
    </div>
  )
}
