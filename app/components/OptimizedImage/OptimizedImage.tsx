...
export function OptimizedImage({
    ...
    const containerStyle: React.CSSProperties = {
        ...
        width: width || 'auto',
        height: height || 'auto',
        backgroundColor: placeholder === 'color' || typeof placeholder === 'string'
            ? (typeof placeholder === 'string' && placeholder !== 'color' ? placeholder : '#f0f0f0')
            : undefined,
        ...style,
    }
...
export function HeroImage({ src, alt, ...props }: Omit<OptimizedImageProps, 'transformations' | 'responsive'>) {
    return (
        <OptimizedImage
            src={src}
            alt={alt}
