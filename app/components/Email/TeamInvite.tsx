      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={section}>
            ...
            <Text style={text}>Hi {invitedUserName},</Text>
            <Text style={text}>
            ...
            <Text style={text}>
              Triven is a comprehensive inventory management solution that helps teams streamline
              their operations, track inventory, and manage orders efficiently.
            </Text>
            ...
            <Text style={footer}>
              This invitation was sent to you by {invitedByUserName}. If you don't recognize this
              invitation or believe it was sent in error, you can safely ignore this email.
            </Text>
