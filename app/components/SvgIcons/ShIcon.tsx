...
interface ShIconProps extends React.ComponentPropsWithoutRef<'svg'> {
  size?: number | string
}

export default function ShIcon({ size = 20, style, ...others }: ShIconProps) {
  return (
    <svg
    ...
    >
      ...
      <g mask="url(#a)">
        ...
        />
        <path fill="#338af3" d="M288 208v48c0 61 80 80 80 80s80-19 80-80v-48z" />
        <path
          fill="#eee"
