...
export default function WorkflowTemplateModal({
    ...
    const handleSubmit = () => {
        ...
        for (const step of formData.steps) {
            ...
            if (step.type === 'conditional_logic' && (!step.conditions || Object.keys(step.conditions).length === 0)) {
                notifications.show({
                    title: t('common:error', 'Error'),
    ...
    const getModalTitle = () => {
        switch (actionType) {
            case 'create': return t('workflows:modal.createTemplate', 'Create Workflow Template')
            case 'edit': return t('workflows:modal.editTemplate', 'Edit Workflow Template')
            case 'clone': return t('workflows:modal.cloneTemplate', 'Clone Workflow Template')
            default: return t('workflows:modal.workflowTemplate', 'Workflow Template')
        }
    }
            ...
            <Stack gap="md">
                    ...
                    <Grid gutter="md">
                        ...
                        <Grid.Col span={6}>
                            <Select
                                ...
                                data={[
                                    { value: "purchase_order", label: t('workflows:entityTypes.purchase_order', 'Purchase Order') },
                                    { value: "stock_adjustment", label: t('workflows:entityTypes.stock_adjustment', 'Stock Adjustment') },
                                    { value: "customer", label: t('workflows:entityTypes.customer', 'Customer') },
                                    { value: "transfer_order", label: t('workflows:entityTypes.transfer_order', 'Transfer Order') },
                                ]}
                ...
                <Paper p="md" withBorder radius="md">
                    ...
                    {formData.steps.length === 0 ? (
                        <Paper p="lg" style={{ backgroundColor: colorScheme === 'dark' ? 'var(--mantine-color-dark-6)' : 'var(--mantine-color-gray-0)' }}>
                                                    ...
                                                    >
                                                        ...
                                                        <Group justify="space-between" mb="md">
                                                            <Group gap="xs">
                                                                ...
                                                                <Badge size="sm" variant="light" color={getStepTypeColor(step.type)}>
                                                                    {t('workflows:step.stepNumber', 'Step {{number}}', { number: index + 1 })}
                                                                </Badge>
                                                        ...
                                                        <Grid gutter="sm">
                                                            ...
                                                            <Grid.Col span={4}>
                                                                <NumberInput
                                                                    ...
                                                                    onChange={(value) => updateStep(step.id, { timeoutDays: Number(value) })}
                                                                    min={1}
                                                                    max={90}
                                                                    size="xs"
                                                                />
                                                            ...
                                                            <Grid.Col span={4}>
                                                                <Checkbox
                                                                    ...
                                                                    onChange={(e) => updateStep(step.id, { isRequired: e.currentTarget.checked })}
                                                                    size="xs"
                                                                    mt="xl"
                                                                />
                                                            </Grid.Col>
                                                            ...
                                                            <Grid.Col span={4}>
                                                                <Checkbox
                                                                    ...
                                                                    onChange={(e) => updateStep(step.id, { autoApprove: e.currentTarget.checked })}
                                                                    size="xs"
                                                                    mt="xl"
                                                                />
                                                            </Grid.Col>
