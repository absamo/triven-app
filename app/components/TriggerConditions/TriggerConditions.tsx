  ...
  return (
    <Card withBorder radius="md" p="md">
      ...
      <Text size="sm" c="dimmed" mb="md">
        {t(
          'workflows:triggerConditions.description',
          'Define when this workflow should be triggered automatically'
        )}
      </Text>
      ...
      <Collapse in={opened}>
        <Stack gap="md">
          ...
          {showThreshold && (
            <Paper p="md" withBorder radius="sm">
              <Group justify="space-between" mb="sm">
                <Text fw={500}>
                  {t('workflows:triggerConditions.threshold', 'Amount Threshold')}
                </Text>
                <Button
                  size="xs"
                ...
                <Group gap="sm">
                  <Select
                    ...
                    data={operators.filter((op) =>
                      ['gt', 'gte', 'lt', 'lte', 'eq'].includes(op.value)
                    )}
          ...
          <Paper p="md" withBorder radius="sm">
            <Group justify="space-between" mb="sm">
              <Text fw={500}>
                {t('workflows:triggerConditions.fieldConditions', 'Field Conditions')}
              </Text>
              <Button
                size="xs"
                variant="outline"
            ...
            <Stack gap="sm">
              ...
              {(!triggerConditions?.fieldConditions ||
                triggerConditions.fieldConditions.length === 0) && (
