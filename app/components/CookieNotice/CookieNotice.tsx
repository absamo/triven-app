    ...
    <Paper className={classes.cookieNotice} shadow="lg" p="md" withBorder>
      <Group justify="space-between" align="flex-start" gap="md">
        <Text size="sm" className={classes.text}>
          Triven uses cookies to maintain user sessions and track marketing efforts. By continuing
          to use our website, you agree to our use of cookies for these purposes. Read our Privacy
          Policy.
        </Text>
        <ActionIcon
          variant="subtle"
