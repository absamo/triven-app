...
const DEMO_CATEGORIES = [
  ...
  },
  {
    ...
    products: [
      ...
      { name: "National Geographic Magazine", brand: "National Geographic", costPrice: 3, sellingPrice: 6 },
...
async function createLocations(companyId: string, count: number = 10) {
  ...
  const frenchLocations = [
    { address: "25 Rue de la République", city: "Lyon", state: "Auvergne-Rhône-Alpes", postalCode: "69002" },
    { address: "45 Boulevard Haussmann", city: "Paris", state: "Île-de-France", postalCode: "75009" },
    { address: "12 Place Bellecour", city: "Lyon", state: "Auvergne-Rhône-Alpes", postalCode: "69002" },
    { address: "78 Rue Paradis", city: "Marseille", state: "Provence-Alpes-Côte d'Azur", postalCode: "13006" },
    { address: "33 Place du Capitole", city: "Toulouse", state: "Occitanie", postalCode: "31000" },
    { address: "56 Cours de l'Intendance", city: "Bordeaux", state: "Nouvelle-Aquitaine", postalCode: "33000" },
    ...
    { address: "67 Rue de la Préfecture", city: "Nice", state: "Provence-Alpes-Côte d'Azur", postalCode: "06000" },
    { address: "14 Place de la Comédie", city: "Montpellier", state: "Occitanie", postalCode: "34000" },
  ]
    ...
    data: [
      {
        ...
        permissions: [
          ...
          "read:stockAdjustments", "create:stockAdjustments", "update:stockAdjustments", "delete:stockAdjustments",
          ...
          "read:purchaseOrders", "create:purchaseOrders", "update:purchaseOrders", "delete:purchaseOrders",
          "read:purchaseReceives", "create:purchaseReceives", "update:purchaseReceives", "delete:purchaseReceives",
          "read:bills", "create:bills", "update:bills", "delete:bills",
          "read:paymentsMade", "create:paymentsMade", "update:paymentsMade", "delete:paymentsMade",
          "read:customers", "create:customers", "update:customers", "delete:customers",
          "read:salesOrders", "create:salesOrders", "update:salesOrders", "delete:salesOrders",
          "read:backorders", "create:backorders", "update:backorders", "delete:backorders",
          "read:invoices", "create:invoices", "update:invoices", "delete:invoices",
          "read:paymentsReceived", "create:paymentsReceived", "update:paymentsReceived", "delete:paymentsReceived",
          "read:agencies", "create:agencies", "update:agencies", "delete:agencies",
          "read:roles", "create:roles", "update:roles", "delete:roles",
          "read:settings", "create:settings", "update:settings", "delete:settings",
          "read:users", "create:users", "update:users", "delete:users",
          "read:sites", "create:sites", "update:sites", "delete:sites",
          "read:transferOrders", "create:transferOrders", "update:transferOrders", "delete:transferOrders",
          "read:analytics", "create:analytics", "update:analytics", "delete:analytics",
          "read:workflows", "create:workflows", "update:workflows", "delete:workflows",
          "read:approvals", "create:approvals", "update:approvals", "delete:approvals",
        ],
      },
      {
        name: "Inventory Manager",
        description: "Oversees all inventory operations, stock level monitoring and optimization, supplier relationship management, purchase order approval and management",
        companyId: companyId,
        permissions: [
          ...
          "read:salesOrders", "create:salesOrders", "update:salesOrders",
          "read:backorders", "create:backorders", "update:backorders", "delete:backorders",

          // Financial Operations
          "read:invoices", "create:invoices", "update:invoices",
          "read:paymentsReceived", "create:paymentsReceived", "update:paymentsReceived",

          // Transfer Orders and Site Management
          "read:transferOrders", "create:transferOrders", "update:transferOrders", "delete:transferOrders",
          "read:sites", "create:sites", "update:sites",

          // Analytics and Reporting for Stock Monitoring
          "read:analytics", "create:analytics", "update:analytics",
          ...
          "read:approvals", "create:approvals", "update:approvals",
        ],
      },
      {
        ...
        permissions: [
          ...
          "read:stockAdjustments", "create:stockAdjustments", "update:stockAdjustments",
          "read:categories",
          "read:purchaseOrders", "read:purchaseReceives", "create:purchaseReceives", "update:purchaseReceives",
          // Transfer Orders and Site Management
          "read:transferOrders", "create:transferOrders", "update:transferOrders", "delete:transferOrders",
          "read:sites", "create:sites", "update:sites",
      ...
      },
      {
        ...
        permissions: [
          ...
          "read:customers", "create:customers", "update:customers",
          "read:salesOrders", "create:salesOrders", "update:salesOrders",
          "read:backorders", "create:backorders", "update:backorders",
          "read:invoices", "create:invoices", "update:invoices",
          "read:paymentsReceived", "create:paymentsReceived", "update:paymentsReceived",
        ],
      },
      {
        ...
        companyId: companyId,
        permissions: [
          "read:products", "read:invoices", "read:bills",
          "read:paymentsReceived", "create:paymentsReceived", "update:paymentsReceived",
          "read:paymentsMade", "create:paymentsMade", "update:paymentsMade",
          "read:analytics", "read:settings",
          "read:customers", "read:suppliers",
          "read:salesOrders", "read:purchaseOrders",
        ],
      },
      {
        ...
        companyId: companyId,
        permissions: [
          "read:products", "read:customers", "update:customers",
          "read:salesOrders", "update:salesOrders",
          "read:invoices", "read:backorders", "update:backorders",
          "read:paymentsReceived",
          "read:categories", "read:agencies", "read:sites",
        ],
      },
      {
        ...
        permissions: [
          "read:products", "update:products",
          "read:stockAdjustments", "create:stockAdjustments",
          "read:purchaseReceives", "update:purchaseReceives",
          "read:categories", "read:suppliers",
          "read:purchaseOrders",
        ],
      },
      {
        ...
        permissions: [
          ...
          "read:customers", "create:customers", "update:customers",
          "read:salesOrders", "create:salesOrders", "update:salesOrders",
          "read:invoices", "create:invoices",
          "read:stockAdjustments", "create:stockAdjustments",
          "read:transferOrders", "create:transferOrders",
          "read:backorders", "update:backorders",
          "read:paymentsReceived", "create:paymentsReceived",
          "read:analytics",
        ],
      },
    ],
...
async function createProducts(company: any, categories: any[], agencies: any[], sites: any[], users: any[]) {
  ...
  for (const categoryData of DEMO_CATEGORIES) {
    ...
    for (const productData of categoryData.products) {
      ...
      if (productIndex % 4 === 0) {
        ...
        physicalStock = productIndex % 8 === 3 || productIndex % 8 === 7 ? 0 : faker.number.int({ min: 1, max: 5 })
      }

      // Distribute products across agencies to ensure proper filtering
      const selectedAgency = faker.helpers.arrayElement(agencies)
      const selectedSite = faker.helpers.arrayElement(sites.filter(s => s.agencyId === selectedAgency.id))
      ...
      const product = await prisma.product.create({
        data: {
          ...
          accountingStockOnHand: Math.random() > 0.3 ? physicalStock : physicalStock + faker.number.int({ min: -3, max: 3 }), // 30% chance of discrepancy
          adjustedQuantity: 0,
          barcode: createEan13(),
  ...
  console.log(`   - Recent (last 7 days): ${Math.ceil(products.length / 4)} products with high stock`)
  console.log(`   - Medium (7-14 days): ${Math.ceil(products.length / 4)} products with medium stock`)
  console.log(`   - Older (14-30 days): ${Math.ceil(products.length / 4)} products with low stock`)
  console.log(`   - Oldest (30-60 days): ${Math.floor(products.length / 4)} products (half out of stock for backorders)`)
...
async function createCustomers(company: any, agencies: any[], sites: any[], locations: any[]) {
  ...
  const frenchCustomerAddresses = [
    { address: "42 Avenue de la Liberté", city: "Lyon", state: "Auvergne-Rhône-Alpes", postalCode: "69003" },
    { address: "18 Rue de Rivoli", city: "Paris", state: "Île-de-France", postalCode: "75001" },
    { address: "85 La Canebière", city: "Marseille", state: "Provence-Alpes-Côte d'Azur", postalCode: "13001" },
    { address: "29 Rue Alsace Lorraine", city: "Toulouse", state: "Occitanie", postalCode: "31000" },
    { address: "67 Cours de l'Intendance", city: "Bordeaux", state: "Nouvelle-Aquitaine", postalCode: "33000" },
    { address: "33 Grande Rue", city: "Lille", state: "Hauts-de-France", postalCode: "59000" },
    { address: "91 Avenue Jean Médecin", city: "Nice", state: "Provence-Alpes-Côte d'Azur", postalCode: "06000" },
    { address: "14 Place de la Cathédrale", city: "Strasbourg", state: "Grand Est", postalCode: "67000" },
  ]
  ...
  const customers = await Promise.all(
    DEMO_CUSTOMERS.map(async (customerData, index) => {
      ...
      const shippingAddressData = frenchCustomerAddresses[(index + 1) % frenchCustomerAddresses.length]
...
async function createPurchaseOrders(company: any, suppliers: any[], agencies: any[], sites: any[], products: any[]) {
  ...
  for (let i = 0; i < 15; i++) {
    ...
    const agencySiteProducts = products.filter(p => p.agencyId === agency.id && p.siteId === site.id)
    if (agencySiteProducts.length === 0) {
      console.log(`Warning: No products found for agency ${agency.name} and site ${site.name}, skipping items for order ${i}`)
      continue
    }
...
async function createSalesOrders(company: any, customers: any[], agencies: any[], sites: any[], products: any[]) {
  ...
  for (let i = 0; i < 20; i++) {
    ...
    console.log(`Sales Order ${salesOrderReference}: Agency ${agency.name}, Site ${site.name} has ${agencySiteProducts.length} products, using ${selectedProducts.length} products`)

    for (const product of selectedProducts) {
      const quantity = faker.number.int({ min: 1, max: 10 })
      const rate = product.sellingPrice * faker.number.float({ min: 0.9, max: 1.1, fractionDigits: 2 })
      const taxPercentage = faker.number.float({ min: 0, max: 20, fractionDigits: 2 }) // Tax percentage between 0% and 20%
...
async function createBackorders(company: any, customers: any[], agencies: any[], sites: any[], products: any[]) {
  ...
  for (let i = 0; i < 25; i++) {
    ...
    const agencySiteProducts = products.filter(p => p.agencyId === agency.id && p.siteId === site.id)
    if (agencySiteProducts.length === 0) {
      console.log(`Warning: No products found for agency ${agency.name} and site ${site.name}, skipping items for backorder ${i}`)
      continue
    }
  ...
  for (let i = 0; i < salesOrders.slice(0, 15).length; i++) {
    ...
    const invoice = await prisma.invoice.create({
      data: {
        ...
        status: faker.helpers.arrayElement([
          "Pending", "Sent", "Paid", "PartiallyPaid", "Overdue", "Unpaid"
        ]),
        companyId: company.id,
        salesOrderId: salesOrder.id,
    ...
    if (faker.datatype.boolean(0.7)) { // 70% chance of payment
      ...
      const payment = await prisma.paymentReceived.create({
        data: {
          ...
          paymentMethod: faker.helpers.arrayElement([
            "Cash", "CreditCard", "BankTransfer", "Cheque"
          ]),
          companyId: company.id,
  ...
  for (let i = 0; i < purchaseOrders.slice(0, 10).length; i++) {
    ...
    const bill = await prisma.bill.create({
      data: {
        ...
        status: faker.helpers.arrayElement([
          "Unbilled", "Sent", "Paid", "PartiallyPaid", "Overdue", "Unpaid"
        ]),
        companyId: company.id,
        purchaseOrderId: purchaseOrder.id,
        userId: faker.helpers.arrayElement(users).id,
    ...
    if (faker.datatype.boolean(0.6)) { // 60% chance of payment
    ...
    const stockAdjustment = await prisma.stockAdjustment.create({
      data: {
        ...
        reason: faker.helpers.arrayElement([
          "DamagedItems", "ExcessStock", "QualityControl", "InternalTransfer",
          "WriteOff", "UnaccountedInventory", "LostItems"
        ]),
...
async function createTransferOrders(company: any, sites: any[], products: any[]) {
  ...
  for (let i = 0; i < 8; i++) {
    ...
    const selectedProducts = faker.helpers.arrayElements(products, faker.number.int({ min: 1, max: 4 }))
    ...
    const transferOrder = await prisma.transferOrder.create({
      data: {
        ...
        reason: faker.helpers.arrayElement([
          "InternalTransfer", "ExcessStock", "Demo", "Other"
        ]),
...
async function createNotifications(company: any, products: any[], users: any[]) {
  ...
  for (let i = 0; i < 20; i++) {
    ...
    const status = faker.helpers.arrayElement([
      "LowStock", "OutOfStock", "RestockReminder", "NewOrder", "NewSale", "Critical"
    ])
...
async function createWorkflowTemplatesAndApprovals(company: any, roles: any[], users: any[], transferOrders: any[]) {
    ...
    data: {
      ...
      data: {
        ...
        products: [
          ...
          { sku: "ELEC002", name: "iPhone 15 Pro", adjustedQuantity: -1, reason: "Défaut batterie" }
        ]
      },
      status: APPROVAL_STATUSES.PENDING,
  ...
  approvalRequests.push(purchaseOrderApproval, stockAdjustmentApproval, customerApproval, transferOrderApproval)
  ...
  await prisma.approvalComment.create({
    data: {
      ...
      comment: "Je révise cette commande. Le montant est élevé mais justifié par nos besoins actuels en équipement.",
      isInternal: true,
    },
  })
  ...
  await prisma.approvalComment.create({
    data: {
      ...
      comment: "Client recommandé par un partenaire de confiance. Historique de paiement excellent.",
      isInternal: false,
    },
  })
